...
export default function LinkCard({
  ...
  return (
    <article className="link-card-hover min-h-[210px] overflow-hidden rounded-xl bg-[var(--surface)] shadow-[var(--card-shadow)]">
      {thumbnail && (
        <div
          aria-label={`${title} 썸네일`}
          className="aspect-[16/9] w-full bg-[var(--surface-hover)] bg-cover bg-center"
          role="img"
